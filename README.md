...
# Install
    ...
    $ go get github.com/pyrotag/gorm-goose/cmd/gorm-goose

This will install the `gorm-goose` binary to your `$GOPATH/bin` directory.

You can also build gorm-goose into your own applications by importing `github.com/pyrotag/gorm-goose/lib/gorm-goose`.
...
import _ "github.com/pyrotag/gorm-goose/cmd/gorm-goose"
```
